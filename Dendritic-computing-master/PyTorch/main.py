...
def set_seed(seed):
    ...
    torch.backends.cudnn.benchmark = False  # False保证实验结果可复现
...
def run(args):
    ...
    model = get_model(args,num_iterations=args.num_iterations).to(device)
...
def parse_args():
    ...
    parser.add_argument('--num_iterations', default=None, type=int, help='number of iterations')
